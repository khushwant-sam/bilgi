...
class WPDD_layout_loop_views_cell_factory extends WPDD_layout_cell_factory{
	...
	public function get_cell_info($template) {
		...
		$template['description'] = __('Use this cell in layouts for the blog, archives, search and other pages that display WordPress loops. You will be able to customize the way content is displayed using a WordPress Archive, from Views plugin.', 'ddl-layouts');
